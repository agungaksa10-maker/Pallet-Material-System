@php
    if (!function_exists('stickerSvgUri')) {
        function stickerSvgUri(string $svg): string {
            return 'data:image/svg+xml;base64,' . base64_encode(trim($svg));
        }
    }

    $andritzLogoSvgUri = stickerSvgUri('<svg viewBox="0 0 1065 210" xmlns="http://www.w3.org/2000/svg">
    ...
    $bannerSvgUri = stickerSvgUri('<svg viewBox="0 0 620 66" xmlns="http://www.w3.org/2000/svg">
    ...
    $warningSvgUri = stickerSvgUri('<svg viewBox="0 0 54 48" xmlns="http://www.w3.org/2000/svg">
    ...
    $monogramSvgUri = stickerSvgUri('<svg viewBox="0 0 264 202" xmlns="http://www.w3.org/2000/svg">
        <g transform="translate(120, -292)" fill="#ffffff">
            <path d="M 52.156894,493.69536 L 26.281784,433.16297 L -19.436146,433.16297 L 9.6166143,370.94573 L 65.173024,493.69536 L 143.26976,493.69536 L 43.104104,293.58229 L -25.468436,293.58229 L -119.91608,493.69536 L 52.156894,493.69536 z" />
        </g>
    </svg>');

    $icon1SvgUri = stickerSvgUri('<svg viewBox="0 0 28 28" fill="none" stroke="#ffffff" xmlns="http://www.w3.org/2000/svg">
    ...
    $icon2SvgUri = stickerSvgUri('<svg viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
    ...
    $icon3SvgUri = stickerSvgUri('<svg viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg">
    ...
    $icon4SvgUri = stickerSvgUri('<svg viewBox="0 0 28 28" fill="none" stroke="#ffffff" xmlns="http://www.w3.org/2000/svg">
...
<head>
    <meta charset="utf-8">
    <title>Pallet Sticker Label - ANDRITZ Standard</title>
    <style>
        @page {
            margin: 0;
            size: 430pt 345pt;
...
@foreach($stickers as $index => $item)
    ...
    <div class="sticker-card {{ $isLast ? 'last-card' : '' }}">
        <div class="inner-content">
            <!-- 1. OFFICIAL ANDRITZ LOGO HEADER -->
            <div class="andritz-logo-container">
                <img src="{{ $andritzLogoSvgUri }}" style="width: 270pt; height: 44pt; display: block; margin: 0 auto;" />
            </div>

            <!-- Solid Blue Horizontal Divider -->
            <div class="blue-divider"></div>

            <!-- 2. HERO PALLET NUMBER ROW: — Pallet #N — -->
            ...
            <div class="banner-container">
                <img src="{{ $bannerSvgUri }}" class="banner-img" />
                <div class="banner-text">{{ $catCode }}</div>
            </div>
            ...
            <table class="warning-table">
                <tr>
                    <td style="width: 38pt; vertical-align: middle; text-align: left; padding: 0;">
                        <img src="{{ $warningSvgUri }}" style="width: 36pt; height: 32pt; display: block;" />
                    </td>
                    <td style="vertical-align: middle; padding-left: 8pt;">
        ...
        <div class="footer-bar">
            <table class="footer-table">
                <tr>
                    <!-- Left: ANDRITZ Monogram "A" + | + Andritz For The Change -->
                    <td style="vertical-align: middle; text-align: left;">
                        <table style="border-collapse: collapse;">
                            <tr>
                                <td style="vertical-align: middle; padding-right: 8pt;">
                                    <img src="{{ $monogramSvgUri }}" style="width: 24pt; height: 18pt; display: block;" />
                                </td>
                                <td style="vertical-align: middle; padding-right: 8pt;">
                                    <div style="width: 1.5pt; height: 18pt; background-color: #ffffff;"></div>
                                </td>
                                <td style="vertical-align: middle;">
                                    <span class="tagline-text">Andritz For The Change</span>
                                </td>
                            </tr>
                        </table>
                    </td>

                    <!-- Right: 4 Logistics Marks -->
                    <td style="vertical-align: middle; text-align: right;">
                        <div class="icon-box">
                            <img src="{{ $icon1SvgUri }}" style="width: 18pt; height: 18pt; display: block; margin: 0 auto;" />
                        </div>
                        <div class="icon-box">
                            <img src="{{ $icon2SvgUri }}" style="width: 18pt; height: 18pt; display: block; margin: 0 auto;" />
                        </div>
                        <div class="icon-box">
                            <img src="{{ $icon3SvgUri }}" style="width: 18pt; height: 18pt; display: block; margin: 0 auto;" />
                        </div>
                        <div class="icon-box">
                            <img src="{{ $icon4SvgUri }}" style="width: 18pt; height: 18pt; display: block; margin: 0 auto;" />
                        </div>
                    </td>
                </tr>
            </table>
