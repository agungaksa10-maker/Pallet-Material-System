...
$palletNumber = 2;
$catCode = 'I-COS';
$catTitle = 'Dressing Material';

$stickerHtml = '<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="sticker-card">
        <div class="inner-content">
            ...
            <div class="andritz-logo-container">
                <svg viewBox="0 0 1065 210" width="260pt" height="42pt" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- 2. HERO PALLET NUMBER ROW: — Pallet #2 — -->
            <table class="hero-table">
                <tr>
                    ...
                    <td style="vertical-align: middle; text-align: center;">
                        <span class="hero-number">Pallet #' . $palletNumber . '</span>
                    </td>
            ...
            <div class="banner-container">
                <svg viewBox="0 0 620 66" class="banner-svg" xmlns="http://www.w3.org/2000/svg">
            ...
            <table class="warning-table">
                <tr>
                    <td style="width: 36pt; vertical-align: middle; text-align: left; padding: 0;">
                        <svg viewBox="0 0 54 48" width="34pt" height="30pt" xmlns="http://www.w3.org/2000/svg">
                ...
                <tr>
                    ...
                    <td style="vertical-align: middle; text-align: left;">
                        <table style="border-collapse: collapse;">
                            <tr>
                                <td style="vertical-align: middle; padding-right: 7pt;">
                                    <svg viewBox="0 0 264 202" width="22pt" height="17pt" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <td style="vertical-align: middle; padding-right: 7pt;">
                                    <div style="width: 1.5pt; height: 16pt; background-color: #ffffff;"></div>
                                </td>
                    ...
                    <td style="vertical-align: middle; text-align: right;">
                        <!-- Icon 1: This Way Up -->
                        <div class="icon-box">
                            <svg viewBox="0 0 28 28" width="16pt" height="16pt" fill="none" stroke="#ffffff" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Icon 2: Fragile -->
                        <div class="icon-box">
                            <svg viewBox="0 0 28 28" width="16pt" height="16pt" xmlns="http://www.w3.org/2000/svg">
...
$dompdf->loadHtml($stickerHtml);
$dompdf->render();
$canvas = $dompdf->getCanvas();
echo "Sticker Page Count: " . $canvas->get_page_count() . "\n";
file_put_contents(__DIR__ . '/public/test_final_sticker.html', $stickerHtml);
file_put_contents(__DIR__ . '/public/test_final_sticker.pdf', $dompdf->output());
